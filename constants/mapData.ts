...
// GPS bounding box for the campus. User outside these bounds = not on campus.
...
export const BUILDINGS: BuildingData[] = [
  {
    ...
    code: 'B',
    label: 'Edificio B',
    aliases: ['Centro de Información', 'Biblioteca'],
  ...
  },
  {
    ...
    aliases: [
      ...
      'Extraescolares',
      'Comité Ejecutivo de Sociedad de Alumnos',
      'CESA',
      'Departamento de Planeación, Programación y Presupuestos',
      'Ciencias Básicas',
    ],
  ...
  },
  {
    ...
    code: 'G',
    label: 'Edificio G',
    aliases: ['Laboratorio de Cómputo'],
  ...
  },
  {
    ...
    code: 'I',
    label: 'Edificio I',
    aliases: ['Laboratorio de Ingeniería Industrial', 'Industrial'],
  ...
  },
  {
    ...
    code: 'J',
    label: 'Edificio J',
    aliases: ['Centro de Lenguas Extranjeras', 'Idiomas', 'Inglés'],
  ...
  },
  {
    ...
    code: 'E',
    label: 'Edificio E',
    aliases: ['Departamento de Ingeniería Eléctrica', 'Eléctrica'],
  ...
  },
  {
    ...
    code: 'A',
    label: 'Edificio A',
    aliases: ['Dirección', 'Recursos Financieros'],
  ...
  },
  {
    ...
    code: 'Q',
    label: 'Edificio Q',
    aliases: ['Laboratorio de Química', 'Química'],
  ...
  },
  {
    ...
    code: 'X',
    label: 'Edificio X',
    aliases: ['Departamento de Ingeniería Electrónica', 'Electrónica'],
  ...
  },
  {
    ...
    code: 'Nodo',
    label: 'Nodo',
    aliases: ['Jefatura de Gestión, Tecnología y Vinculación', 'Posgrado'],
